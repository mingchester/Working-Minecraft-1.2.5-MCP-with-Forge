...
public class EntityRenderer
{
    ...
    public void renderWorld(float par1, long par2)
    {
        ...
        for (int var18 = 0; var18 < 2; ++var18)
        {
            ...
            this.setupCameraTransform(par1, var18);
            ...
            this.mc.renderGlobal.clipRenderersByFrustum(var19, par1);
            ...
            if (var18 == 0)
            {
                ...
                {
                    long var20 = par2 - System.nanoTime();
            ...
            if (this.debugViewDirection == 0)
            {
                ...
                var5.renderEntities(var4.getPosition(par1), var19, par1);
                this.enableLightmap((double)par1);
                ...
                if (this.mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !this.mc.gameSettings.hideGUI)
                {
                    ...
                    var5.drawBlockBreaking(var21, this.mc.objectMouseOver, 0, var21.inventory.getCurrentItem(), par1);
                    var5.drawSelectionBox(var21, this.mc.objectMouseOver, 0, var21.inventory.getCurrentItem(), par1);
